...
class SingleCategory extends Widget_Base {
	...
	protected function register_styles(): void {
		...
		//Directory type
		$this->register_container_style_controls( __( 'Directory Type: Container', 'addonskit-for-elementor' ), 'all_listing_directory_type_container', '.directorist-type-nav__list', directorist_is_multi_directory_enabled() ? '' : ['nocondition' => true] );
